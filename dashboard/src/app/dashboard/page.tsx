    ...
    <div className="min-h-screen pb-16">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-20 pb-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div>
            <h1 className="text-2xl font-bold text-[#1a1a2e]">Demand &amp; capacity projections</h1>
            <p className="text-sm text-[#9aa0a6]">2025 – 2035 outlook across all sites</p>
          </div>
          <SegmentedToggle
      ...
      <div className="max-w-6xl mx-auto px-6 mb-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <GlassCard>
            <p className="text-xs text-[#9aa0a6] mb-1">ED demand 2035</p>
            <AnimatedCounter value={edDemand2035} className="text-xl font-bold text-[#1a1a2e]" />
          </GlassCard>
          <GlassCard>
            <p className="text-xs text-[#9aa0a6] mb-1">OR demand 2035</p>
            <AnimatedCounter value={orDemand2035} className="text-xl font-bold text-[#1a1a2e]" />
          </GlassCard>
          <GlassCard accent={edGap2035 >= 0 ? "#059669" : "#dc2626"}>
            <p className="text-xs text-[#9aa0a6] mb-1">ED gap 2035</p>
            <AnimatedCounter value={edGap2035} className="text-xl font-bold text-[#1a1a2e]" />
            <div className="mt-1"><RagBadge gap={edGap2035} /></div>
          </GlassCard>
          <GlassCard accent={orGap2035 >= 0 ? "#059669" : "#dc2626"}>
            <p className="text-xs text-[#9aa0a6] mb-1">OR gap 2035</p>
            <AnimatedCounter value={orGap2035} className="text-xl font-bold text-[#1a1a2e]" />
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-5">
          ...
          <div className="flex-1 space-y-5">
            ...
            <GlassCard>
              <h3 className="text-sm font-semibold text-[#1a1a2e] mb-3">Site breakdown</h3>
          ...
          <div className="w-full lg:w-72 flex-shrink-0">
            <div className="card p-5 sticky top-20">
              <h3 className="text-sm font-semibold text-[#1a1a2e] mb-1">Assumptions</h3>
              <p className="text-[11px] text-[#9aa0a6] mb-5">
                Adjust parameters. Click &#x24D8; for sources.
              </p>

              {tab === "ed" ? (
                <>
                  <p className="text-[10px] font-semibold text-[#0d9488] uppercase tracking-wider mb-2">Demand drivers</p>
                  ...
                  <div className="border-t border-[#e9ecef] my-3" />
                  <p className="text-[10px] font-semibold text-[#0d9488] uppercase tracking-wider mb-2">Capacity</p>
                ...
                <>
                  <p className="text-[10px] font-semibold text-[#2563eb] uppercase tracking-wider mb-2">Demand drivers</p>
                  ...
                  <div className="border-t border-[#e9ecef] my-3" />
                  <p className="text-[10px] font-semibold text-[#2563eb] uppercase tracking-wider mb-2">Capacity</p>
              ...
              <button
                ...
                className="w-full mt-3 py-1.5 rounded-lg bg-[#f8f9fa] border border-[#e9ecef] text-xs text-[#5f6368] hover:text-[#1a1a2e] transition-colors cursor-pointer"
              >
